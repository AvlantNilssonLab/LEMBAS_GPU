...
def train_signaling_model(mod,  
    ...
    for e in range(hyper_params['max_iter']):
        ...
        for batch, (X_in_, y_out_) in enumerate(train_dataloader):
            ...
            param_reg = mod.L2_reg(lambda_L2 = hyper_params['param_lambda_L2'], 
                                  output_bias_lambda_L2 = hyper_params['output_bias_lambda_L2']) # all model weights and signaling network biases
