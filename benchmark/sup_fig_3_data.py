...
def benchmark_this_dict(dict_to_bench):
   ...
   # Box plot for box_plot_correlator
    if dict_to_bench['test_eigen_1_or_uni_0']==1:
        ...
        df.to_csv("LEMBAS/data_to_report/sup_fig_1_2_3/input_data_XX_YY_comparison_power_iter.csv", index=False)
        print("Figures are saved PI")
    else:
        print("Figures are saved unif")
        print("-----------------------------------------------------")
...
dict_to_bench={"name": "power_iter", "L2_or_rand" :0,"test_eigen_1_or_uni_0":1,"device": "cuda"}
